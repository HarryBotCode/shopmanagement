...
const TotalBusinessExpense = ({setBusinessExpenses, setExpenses}) => {
  return (
    <>
    <Flex 
    flexDir='row' 
    ...
    <Button onClick={ () => setBusinessExpenses(true) & setExpenses(false) } w='85%' leftIcon={<AiFillFilePdf color='white'/>}  rounded='2xl' bg='#0066ff' color='white' _hover={{transform:'Scale(1.03)'}}>Add Business Expense</Button>
        </Flex>
