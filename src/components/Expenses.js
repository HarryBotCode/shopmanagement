  ...
  return (
    ...
    justifyContent='flex-start'>
        ...
        <Heading as='h3' size='lg'>Expenses</Heading> 
            ...
            <Button onClick={ () => setBusinessExpenses(true) & setExpenses(false) }w='85%' mt='20px' leftIcon={<AiFillFilePdf color='white'/>}  rounded='2xl' bg='#0066ff' color='white' _hover={{transform:'Scale(1.03)'}}>Add Business Expense</Button>
        </Flex>
        </>
      )
}
