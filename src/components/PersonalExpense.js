...
const PersonalExpense = ({setExpenses, setPersonalExpenses, setBusinessExpenses, setTotalPersonalExpenses}) => {
    ...
    const handleClick = () => {
        ...
        setShowComponent([...showComponent, <FormToAdd key={showComponent.length}  onDelete={() => handleDelete(showComponent.length)}  />])
    };
        ...
        <>
            <Flex
                ...
                <Flex w='100%' flexDir='row' alignItems='center' rounded='md' bg='white' p='6' justifyContent='space-between' mt='20px'>
                    <IconButton onClick={() => setTotalPersonalExpenses(true) & setExpenses(false) & setPersonalExpenses(false) & setBusinessExpenses(false)} icon={<IoMdArrowRoundBack color='#0066ff' size='25px' />} ></IconButton>
                ...
                <Flex flexDir='column' justifyContent='space-between' p='12'>
                    <Flex flexdir='row' justifyContent='space-between' alignItems='center'><Heading>Personal Expense</Heading>
