import { Button, Flex, Heading, Highlight, IconButton, Input, Menu, MenuButton, MenuItem, MenuList, Text } from '@chakra-ui/react'
...
const SearchInvoice = ({setSearchinv, setInv}) => {
  return (
   <>
    <Flex 
    flexDir='row' 
    ...
    <Button onClick={() => setSearchinv(true) & setInv(false)} w='85%' leftIcon={<AiFillFilePdf color='white'/>}  rounded='2xl' bg='#0066ff' color='white' _hover={{transform:'Scale(1.03)'}}>Add New Invoice</Button>
        </Flex>
