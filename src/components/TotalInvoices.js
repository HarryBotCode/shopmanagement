import { Button, Flex, Heading, IconButton, Input, Menu, MenuButton, MenuItem, MenuList ,Text, Highlight} from '@chakra-ui/react'
...
const TotalInvoices = ({setSearchinv, setInv}) => {
  return (
    <>
    <Flex 
    flexDir='row' 
